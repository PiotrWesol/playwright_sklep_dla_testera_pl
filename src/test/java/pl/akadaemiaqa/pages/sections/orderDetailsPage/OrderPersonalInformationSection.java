...
import pl.akademiaqa.dto.PersonalInformationDto;
...
public class OrderPersonalInformationSection extends BasePage {
    ...
    public OrderAddressSection enterPersonalInformation() {
        ...
        PersonalInformationDto personalInfo = PersonalInformationDto.getPersonalInformationDto();
        selectSocialTitleMr().enterFirstName(personalInfo.getFirstName())
